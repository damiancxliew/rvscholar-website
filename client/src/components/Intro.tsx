  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        many generations of Singaporeans that have went on to contribute
      ...
      <Paragraph>
        ...
        RVHS was selected to be in the pioneer batch of six schools to be
        granted the Autonomous Status (AS). In 2006, RVHS was given the green
        light to run the Integrated Programme (IP). These give RVHS its present
      ...
      <Paragraph>
        ...
        This is done through our Balanced Education Curriculum (BEC), which
        comprises the Cognitive-Interest Development Curriculum (CIDC), the
      ...
      <Paragraph>
        <ul>
          <li>
            ...
            and knowledge construction, as well as prepares students for
            university admission. It is designed based on the ASK (Attitudes,
            Skills and Knowledge) learning culture and implemented with the TfU
            (Teaching for Understanding) Framework from the Harvard Graduate
            School of Education.
          </li>
          <li>
            <b>LCDC</b> seeks to provide Character and Citizenship Education
            (CCE) for students. Through components like the Overseas
            Experiential Learning Programme (OELP), Enhanced National Education
            (NE) and Values in Action (VIA) Programme and platforms such as the
            Y.LEAD Seminar, LCDC aims to nurture students who practise
            values-based citizenship and leadership.
          </li>
          <li>
            <b>CGDC</b> focuses on developing students’ civic-mindedness and
            global perspective. The main components of the CGDC programme are
            the Construct, Integrate, Differentiate (CID) programme,
            Appreciation of Chinese Culture (ACC) programme and the six
            academies.
          </li>
        </ul>
      </Paragraph>
